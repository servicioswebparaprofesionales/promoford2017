...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body style="overflow:hidden;font-family: Arial, Helvetica, sans-serif;font-size: 12px;">
		<div id="politicas">
			<h1>Politicas de Privacidad</h1>
			<p>Por medio de nuestra política de privacidad le ponemos al tanto de las debidas condiciones de uso en este sitio. La utilización de estos implica su aceptación plena y sin reservas a todas y cada una de las disposiciones incluidas en este Aviso Legal, por lo que si usted no está de acuerdo con cualquiera de las condiciones aquí establecidas, no deberá usar u/o acceder a este sitio. Reservamos el derecho a modificar esta Declaración de Privacidad en cualquier momento. Su uso continuo de cualquier porción de este sitio tras la notificación o anuncio de tales modificaciones constituirá su aceptación de tales cambios.</p>

			<h3>Galletas o Cookies</h3>
			<p>Este sitio hace uso de cookies, el cual son pequeños ficheros de datos que se generan en su ordenador, el cual envía información sin proporcionar referencias que permitan deducir datos personales de este.
			...
			<p>Política De Privacidad De Fuentes De Rastreo Utilizadas En Este Sitio:
			Google (Analytics): http://www.google.com/intl/es_ALL/privacypolicy.html
			</p>

			<h3>Política De Protección De Datos Personales</h3>
			<p>Para utilizar algunos de los servicios o acceder a determinados contenidos, deberá proporcionar previamente ciertos datos de carácter personal, que solo serán utilizados para el propósito que fueron recopilados.<br />
			...
			Completando nuestro formulario usted autoriza a que sus datos sean compartidos con empresas para que las mismas puedan responder a sus inquietudes.
